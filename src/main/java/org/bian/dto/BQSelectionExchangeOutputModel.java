...
/**
 * BQSelectionExchangeOutputModel
 */
public class BQSelectionExchangeOutputModel   {
  ...
  private String selectionExchangeActionTaskReference = null;

  private Object selectionExchangeActionTaskRecord = null;

  private String selectionExchangeActionResponse = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to a Selection instance exchange service call 
   * @return selectionExchangeActionTaskReference
  **/

  public String getSelectionExchangeActionTaskReference() {
    return selectionExchangeActionTaskReference;
  }

  public void setSelectionExchangeActionTaskReference(String selectionExchangeActionTaskReference) {
    this.selectionExchangeActionTaskReference = selectionExchangeActionTaskReference;
  }
  ...
  **/
   ...
   * @return selectionExchangeActionResponse
  **/

  public String getSelectionExchangeActionResponse() {
    return selectionExchangeActionResponse;
  }

  public void setSelectionExchangeActionResponse(String selectionExchangeActionResponse) {
    this.selectionExchangeActionResponse = selectionExchangeActionResponse;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: The status of the Selection instance (e.g. accepted, rejected, verified) 
