...
/**
 * BQSecuritizationRequestOutputModel
 */
public class BQSecuritizationRequestOutputModel   {
  private String securitizationRequestActionTaskReference = null;

  private Object securitizationRequestActionTaskRecord = null;

  private String securitizationRequestRecordReference = null;
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to a Securitization instance request service call 
   * @return securitizationRequestActionTaskReference
  **/

  public String getSecuritizationRequestActionTaskReference() {
    return securitizationRequestActionTaskReference;
  }

  public void setSecuritizationRequestActionTaskReference(String securitizationRequestActionTaskReference) {
    this.securitizationRequestActionTaskReference = securitizationRequestActionTaskReference;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Binary  general-info: The request service call consolidated processing record 
   * @return securitizationRequestActionTaskRecord
  **/

  public Object getSecuritizationRequestActionTaskRecord() {
    return securitizationRequestActionTaskRecord;
  }

  public void setSecuritizationRequestActionTaskRecord(Object securitizationRequestActionTaskRecord) {
    this.securitizationRequestActionTaskRecord = securitizationRequestActionTaskRecord;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to the Securitization service request record 
   * @return securitizationRequestRecordReference
  **/

  public String getSecuritizationRequestRecordReference() {
    return securitizationRequestRecordReference;
  }

  public void setSecuritizationRequestRecordReference(String securitizationRequestRecordReference) {
    this.securitizationRequestRecordReference = securitizationRequestRecordReference;
  }
