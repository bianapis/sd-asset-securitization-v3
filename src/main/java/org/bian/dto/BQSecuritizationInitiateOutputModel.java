...
/**
 * BQSecuritizationInitiateOutputModel
 */
public class BQSecuritizationInitiateOutputModel   {
  private String securitizationInstanceReference = null;

  private String securitizationInitiateActionReference = null;

  private Object securitizationInitiateActionRecord = null;
  ...
  **/
   ...
   * @return securitizationInitiateActionReference
  **/

  public String getSecuritizationInitiateActionReference() {
    return securitizationInitiateActionReference;
  }

  public void setSecuritizationInitiateActionReference(String securitizationInitiateActionReference) {
    this.securitizationInitiateActionReference = securitizationInitiateActionReference;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Binary  general-info: The Initiate service call input and output record 
   * @return securitizationInitiateActionRecord
  **/

  public Object getSecuritizationInitiateActionRecord() {
    return securitizationInitiateActionRecord;
  }

  public void setSecuritizationInitiateActionRecord(Object securitizationInitiateActionRecord) {
    this.securitizationInitiateActionRecord = securitizationInitiateActionRecord;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: The status of the Securitization instance (e.g. initialised, pending, active) 
